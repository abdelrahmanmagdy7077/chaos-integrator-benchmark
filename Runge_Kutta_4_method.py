def runge_kutta_4(derivative, t_start, t_end, y_initial, step_size):
    ...
    #idk if that will fix floating point problems
    ...
    for _ in range(num_steps):
        ...
        average_of_derivatives = step_size * 1 / 6 * (k1 + 2 * k2 + 2 * k3 + k4)

        y_next = y_current + average_of_derivatives
        t_next = t_current + step_size

        time_points.append(t_next)
        solution_points.append(y_next)
